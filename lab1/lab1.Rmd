...
fsr <- function(data_treino, data_teste, p_max = 40) {
  # objetos
...
obj <- fsr(db[shuffle == 1,], db[shuffle == 2,], p_max = 10)
...
a <- fsr_cv(db, p_max = 20)

# fazer gráico estilo elbow plot para determinar quantidade de preditoras.
# Com isso, atualizar a questão 4.
```
