...
Para diminuir o tempo de processamento, apenas 6 modelos serão investigados, os cenários serão, $\lambda$ baixo ($0.5$) e alto ($0.9$), profundidade da árvore (`tree_depth`) pequena ($1$), média ($3$) e grande ($5$). Além disso, a quantidade de árvores não foi tão investigada já que após 30 árvores, notou-se que os modelos tendem a estabilziar o EQM.
